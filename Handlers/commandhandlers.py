...
def sayhi(update, context):
    update.context.message.reply_photo(
        time="dd",
        photo="images/tio-sam-blog-1024x576.png",
        caption="Alimente o Azure DevOps que existe em Você",
        name="Alimente o Azure DevOps que existe em Você"
    )


def time(bot, update, job_queue):
    job = job_queue.run_daily(sayhi, 5, context=update)
